...
limit_out=1000# limit_out 上传的流量限制，单位GB，如果不限制就是0，如果限制1T就是1024
...
while True:
	...
	killssr="'curl -d \"text=sgp2 run out of bandwidth\" -X POST https://tgbot.lbyczf.com/sendMessage/cnbe1mjnqnx79p > /dev/null 2>&1'"
